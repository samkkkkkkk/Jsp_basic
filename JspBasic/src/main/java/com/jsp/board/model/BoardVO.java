...
3. 생성자는 매개값을 갖지 않는 생성자(필수), 매개값을 받는 생성자(선택)가 존재한다.
4. 모든 getter/setter 메서드는 접근 제한이 public 이여야 한다.	 
*/
...
public class BoardVO {
	...
	public BoardVO(String writter, String title, String content, LocalDateTime regDate) {
		super();
	...
	public String toString() {
		return "BoarVO [writter=" + writter + ", title=" + title + ", content=" 
